...
const content: Record<"zh" | "en", any> = {
  zh: {
    ...
    timelineItems: [
      ...
      { year: "2026/04", title: "实用新型专利获授权", desc: "啮齿类动物行为学测试实验箱专利获得授权", url: "https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui"},
  ...
  en: {
    ...
    timelineItems: [
      ...
      { year: "2026/04", title: "Utility Model Patent Granted", desc: "Behavioral Testing Chamber Patent Granted", url: "https://pss-system.cponline.cnipa.gov.cn/documents/detail?prevPageTit=changgui"},
